...
#ifndef _WLR089U0_PIO_
#define _WLR089U0_PIO_
...
#define PIN_PA27G_TAL_BRK              _L_(27) /**< \brief TAL signal: BRK on PA27 mux G */
#define MUX_PA27G_TAL_BRK               _L_(6)
#define PINMUX_PA27G_TAL_BRK       ((PIN_PA27G_TAL_BRK << 16) | MUX_PA27G_TAL_BRK)
#define PORT_PA27G_TAL_BRK     (_UL_(1) << 27)
