...
:NOPYTHON
echo This tool require Python v2.x. Kindly change the path of Python version details in the variable "PythonVersion" of bat file "same70_xplained_pro_firmware_update.bat".
popd
exit /b 2
:HASPYTHON
